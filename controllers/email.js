...
const sendMail = async (req, res) => {
  ...
  let texto = `Hola ${nGrupo.toUpperCase()} ${cantT} ${textoP} a *${evento.toUpperCase()}*  http://localhost:4200/core/invitaciones${fiestaDB.invitacion}${fiestaDB._id}/${boletoDB._id} con  *${cantP}* ${boletoP} *FAVOR DE CONFIRMAR ASISTENCIA*`
  await transporter.sendMail({
    from: '"Invitacion" <info@cochisweb.com>', // sender address
    to: boleto.email + ', ing.oarrs@gmail.com', // list of receivers
